...
- [`STORE_LISTING.fr.md`](./STORE_LISTING.fr.md) : fiche française.
- [`STORE_LISTING.en.md`](./STORE_LISTING.en.md) : fiche anglaise.
- [`STORE_LISTING.zh-CN.md`](./STORE_LISTING.zh-CN.md) : fiche chinoise simplifiée.
- [`STORE_LISTING.es.md`](./STORE_LISTING.es.md) : fiche espagnole.
- [`STORE_LISTING.pt-BR.md`](./STORE_LISTING.pt-BR.md) : fiche portugaise.
- [`DATA_DISCLOSURE.md`](./DATA_DISCLOSURE.md) : texte de divulgation et consentement à intégrer dans l’extension.
- [`PRIVACY_PRACTICES.md`](./PRIVACY_PRACTICES.md) : réponses prêtes pour l’onglet Privacy practices.
- [`TEST_INSTRUCTIONS.md`](./TEST_INSTRUCTIONS.md) : procédure destinée aux examinateurs.
- [`PUBLISHING_CHECKLIST.md`](./PUBLISHING_CHECKLIST.md) : contrôle final avant soumission.

Documents publics situés à la racine :
