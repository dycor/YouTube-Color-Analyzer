...
> **Traitement des données :** ce n’est qu’après votre acceptation de la divulgation en vigueur dans l’extension et le démarrage explicite de l’analyse que celle-ci lit localement l’adresse de la page YouTube, l’identifiant vidéo et l’état du lecteur nécessaires pour détecter et cadrer une vidéo compatible. Elle observe ce contexte uniquement pendant la session d’analyse active partagée par le panneau latéral et la fenêtre détachable. L’extension capture temporairement le rendu visuel de l’onglet actif, sans audio, et recadre la zone vidéo pour calculer les instruments. « Arrêter » depuis l’une des interfaces, une navigation ou la fin de la capture arrêtent immédiatement l’observation du contexte et la capture ; fermer la dernière interface déclenche le même arrêt après un bref délai de rechargement. Les pixels, l’adresse de la page et l’état de lecture restent dans votre navigateur. Aucune image ou donnée de lecture n’est envoyée à un serveur, à l’éditeur ou à un tiers. Aucune image n’est enregistrée automatiquement ; un PNG local de l’image détaillée exacte en pause est créé uniquement lorsque vous choisissez explicitement Exporter l’image. Les préférences d’affichage et la version du consentement sont conservées dans le stockage local de Chrome. Un identifiant de capture et le dernier état technique sont conservés temporairement dans le stockage de session et disparaissent au plus tard à la fin de la session du navigateur.

## Description détaillée

Color Analyzer for YouTube affiche des instruments colorimétriques dans le panneau latéral de Chrome ou une fenêtre d’analyse détachable à partir des pixels visibles de la vidéo en cours de lecture.
...
« Arrêter » depuis l’une des interfaces, une navigation ou la fin de la capture arrêtent immédiatement l’observation du contexte et la capture. Le panneau et la fenêtre détachable partagent une même session ; fermer la dernière interface déclenche le même arrêt après un bref délai de rechargement. Les pixels, l’adresse de la page et l’état de lecture restent dans votre navigateur. Aucune image ou donnée de lecture n’est envoyée à un serveur, à l’éditeur ou à un tiers. Aucune image n’est enregistrée automatiquement ; un PNG local de l’image détaillée exacte en pause est créé uniquement lorsque vous choisissez explicitement Exporter l’image. Les préférences d’affichage et la version du consentement sont conservées dans le stockage local de Chrome. Un identifiant de capture et le dernier état technique sont conservés temporairement dans le stockage de session et disparaissent au plus tard à la fin de la session du navigateur.
...
Ouvrez une page YouTube classique, cliquez sur l’icône de l’extension et acceptez la divulgation affichée lors de la première utilisation. Le panneau latéral s’ouvre et l’analyse démarre pour la vidéo visible de l’onglet sélectionné. Vous pouvez ensuite ouvrir une fenêtre détachable sans lancer une seconde capture.

Pendant la lecture, les instruments sont actualisés en direct jusqu’à 512 colonnes horizontales. Lorsque la vidéo est en pause, l’image détaillée utilise jusqu’à 1920 colonnes. Les trois instruments sont calculés à partir de la même image. Vous pouvez régler l’intensité de la trace, consulter les minimums/maximums RGB et exporter explicitement l’image détaillée exacte en pause sous forme de PNG local. Les réglages sélectionnés sont mémorisés localement.

CONFIDENTIALITÉ

Tout le calcul est réalisé sur l’appareil. Les pixels vidéo restent dans la mémoire de travail locale pendant la session d’analyse active. À l’arrêt, la source vidéo est libérée et le canvas est réinitialisé à 1 × 1 pixel. Aucune image n’est enregistrée automatiquement ou envoyée vers un serveur. Un PNG n’est écrit sur l’appareil qu’après le choix explicite Exporter l’image sur une mesure détaillée en pause ; l’extension ne conserve aucun historique d’export. Elle ne possède aucun backend, aucune publicité, aucun outil d’analyse d’audience et ne capture pas l’audio.
...
CAPACITÉS ET LIMITES DE LA VERSION 1.1
...
1. **Trois instruments colorimétriques directement dans Chrome**  
   Parade YRGB/RGB, Waveform et Vecteurscope dans le panneau latéral ou une fenêtre détachable.
2. **Analyse en direct pendant la lecture**  
   Suivez la luminance, les canaux RGB et la saturation au fil de la vidéo.
3. **Une image détaillée et exportable en pause**
   Inspectez jusqu’à 1920 colonnes horizontales et enregistrez explicitement l’image exacte analysée sous forme de PNG local.
4. **Réglages familiers pour les coloristes**  
   Canaux YRGB, intensité de trace, minimums/maximums RGB, affichage colorisé ou monochrome et ligne indicative des tons chair.
5. **Traitement local et non destructif**  
   Aucune image envoyée ou enregistrée automatiquement ; la vidéo n’est jamais modifiée.
